...
def edit_this_entry(receipt_no):
    ...
    def generate_receipt_new():
        ...
        if sp_stop==0 and mon_stop==0:
            ...
            matter = f"""       Agroh Ratlam TOLLWAYS Pvt. Ltd.
        MDR ( 00.00 - 43.85)km
Delanpur Toll Plaza Ratlam (at 10.50)
    Govt Notification No S.O. XXX
-----------------Toll Receipt-----------------
...
Valid Till : {valid_till} """
            ...
            matterp = f"""       Agroh Ratlam TOLLWAYS Pvt. Ltd.
        MDR ( 00.00 - 43.85)km
Delanpur Toll Plaza Ratlam (at 10.50 Km)
    Govt Notification No S.O. XXX
-----------------Toll Receipt-----------------
Receipt No        :  {receipt_number}
