q   `<!-- this is dashboard of a normal staff who will be doing the entries -->
<!DOCTYPE html>
<html>
...
<body onload="show_clock()">
    ...
    <center>
        ...
        <a id="0" style='float:left;margin-left:20px;border:3px solid black;' onclick="vehicle(0)"><img src='images/car.png' width='180px' height='120px'></a>
        <a id="1" style='float:left;border:3px solid black;margin-left:50px;'onclick="vehicle(1)"><img src='images/lcv.jpg' width='180px' height='120px'></a>
        <a id="2" style='float:left;border:3px solid black;margin-left:50px;'onclick="vehicle(2)"><img src='images/bus.png' width='180px' height='120px'></a>
        <a id="3" style='float:left;border:3px solid black;margin-left:50px;'onclick="vehicle(3)"><img src='images/truck.jpg' width='180px' height='120px'></a>
        <a id="4" style='float:left;border:3px solid black;margin-left:50px;'onclick="vehicle(4)"><img src='images/mexle.jpg' width='180px' height='120px'></a>
        <a id="5" style='float:left;border:3px solid black;margin-left:50px;'onclick="vehicle(5)"><img src='images/na.png' width='180px' height='120px'></a>
        <table border='2px solid black;'  style="margin-left:143px; margin-right:200px;">
        <tr> 
        <th width="400px;" >Car</th><th width="400px;">LCV</th><th width="400px;">BUS</th><th width="400px;">TRUCK</th><th width="400px;">M-EXLE</th><th width="385px;">NA</th>
        </tr>
        </table>
        <!-- html form to take entries of vehicles to generate receipts -->
        
        <form method="POST" action="action.php" style='float:left;font-size:26px;border:none;width:1400px;'  >
        
            <br>
             <br><br><select name="v_type" onchange="check_na()" size="10" required id='class' style="float:left;" >
                <?php
            ...
            <label>Vehicle Number : </label><input type="text" name="v_number" placeholder="Enter the vehicle number" required=True max=8 >
            <br><br><br>
            Journey Type : <br><br><select name="journey_type" id="j_type" onchange="Exemption_Type()" size="4" required>
            ...
            <div id="exemption_type" style='display:none;'>
                <br>
                Exemption Type : <br><br><select name="exemption_type" size="7">
                    <option selected value="Amb">Ambulance</option>
		...
		<!--	<img src='http://admin:aidpl12345@192.168.1.65:80/ISAPI/Streaming/channels/101/httpPreview' width='400px' height='300px'> -->
                    <div class="col-md-12 text-center" align="center" style="margin-left:500px;" >
                        <br />
        ...
        <script language="JavaScript">
            ...
            function vehicle(p){
                ...
                var class_v=document.getElementById("class");
        class_v.selectedIndex=p;
