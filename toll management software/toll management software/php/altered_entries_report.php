...
<body>
    <h2 align="center">Edited Entries Report</h2>
    <center>
        <form method="POST">
            <br><br>
            <?php
           ...
           /* if ($str_id == "ALL" && $str_v_type == "ALL") {
            ...
            if (!$data) {
                ...
                while ($array = mysqli_fetch_array($data)) {
                    if($array['V_TYPE']!=$array['OLD_V_TYPE']){
                ...
                ?>
                <button onclick="exportTableToExcel('excel-area', filename = 'edited-entries-report.php')">Excel File</button>
                <?php
                echo "<br><br><div class='print_container'><table border='2px' id='excel-area'>";
                echo "<thead>";
                echo "<tr>";
                echo "<th colspan='16'>Sarlapada, Ratlam(M.P.)<br>Toll Plaza Sarlapada,Sarwan Ratlam -Sailana-Banswada Road SH-39,Ratlam(MP)<br><br>Edited Entries Report</th>";
                echo "</tr>";
                echo "<tr>";
                echo "<th colspan='16'><br>Lane : ALL &ensp; Shift : $shift &ensp; Operator : ALL &ensp; Start date : $param_from_date &ensp; End date : $param_to_date &ensp; Journey Direction : ALL <br><br> Vehicle Type :ALL &ensp; Journey Type : ALL &ensp; User : ALL &ensp; Total Amount : $total_toll &ensp; Total No. of Trans. : $total_no_of_trans</th>";
                echo "</tr>";
