...
<body>
    ...
    if(navigator.msSaveOrOpenBlob){
        ...
        if (isset($_POST["submit"])) {
            ...
            ?>
            <button onclick="exportTableToExcel('excel_area', filename = 'traffic-revenue-report')">Excel File</button>
            <?php
            ...
            <thead>
                ...
                <tr>
                    <th colspan='4' style='border:none;'>Sarlapada, Ratlam(M.P.)<br>Toll Plaza Sarlapada,Sarwan Ratlam -Sailana-Banswada Road SH-39,Ratlam(MP)<br>Traffic Revenue Report</th>
                </tr>
                <tr>
                    <td colspan='1' style='border:none;'>$from_date to $to_date  </td>
                    <td style='border:none;'>Lane : $lane </td>
                    
                    <td colspan='2' style='border:none;'>Shift:$shift </td>
                </tr>
            ...
            echo "<tr>
                <td colspan='4'>Total Traffic Count : $total[1] &ensp; Total Amount : $total[0]   </td>
            </tr>";
        }
